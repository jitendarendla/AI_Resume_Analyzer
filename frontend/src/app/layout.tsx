      ...
      <body className="font-sans antialiased bg-[#F8F5F1] text-[#2B241F] selection:bg-[#0047AB] selection:text-white" suppressHydrationWarning>
        <ClerkProvider
          ...
          appearance={{
            ...
            elements: {
              rootBox: 'font-sans',
              cardBox: 'shadow-2xl border border-[#E8E2D9] rounded-3xl bg-white overflow-hidden',
              card: 'bg-white border-none shadow-none rounded-3xl p-0 overflow-hidden',
              headerTitle: 'font-black text-[#2B241F] font-heading text-xl',
              headerSubtitle: 'font-semibold text-[#60534A] text-xs',
              socialButtonsBlockButton: 'border border-[#E2D7CB] bg-[#FAF6F1] hover:bg-[#EFE7DE] text-[#2B241F] font-bold text-xs rounded-2xl py-3',
              ...
              formFieldInput: 'rounded-2xl border border-[#E2D7CB] bg-[#FAF6F1] focus:bg-white text-[#2B241F] font-bold text-xs py-3 px-4 focus:border-[#0047AB] focus:ring-2 focus:ring-[#0047AB]/10 transition-all',
              footerActionLink: 'text-[#0047AB] font-black hover:underline text-xs',
              footer: 'bg-[#FAF6F1] border-t border-[#E8E2D9] rounded-b-3xl p-4',
              navbar: 'bg-[#FAF6F1] border-r border-[#E8E2D9]',

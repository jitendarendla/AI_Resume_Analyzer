    ...
    >
      <div>
        ...
        <div className={`h-20 flex items-center border-b border-[#2B231D] bg-[#140F0C] transition-all ${
          collapsed ? 'justify-center px-2 gap-1.5' : 'justify-between px-4'
        }`}>
          ...
          <button
            ...
            className="p-1.5 rounded-xl bg-[#241D18] hover:bg-[#332A23] text-[#A3968A] hover:text-white transition-all border border-[#3A3027] shrink-0 cursor-pointer"
          >
